        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <Link href="/">
                <img src={logoImage} alt="GuruTattva" className="h-8 w-auto cursor-pointer" data-testid="img-news-logo" />
              </Link>
            </div>
            <h1 className="text-xl font-serif font-semibold text-primary" data-testid="text-news-title">
              Latest News
            </h1>
            <div className="w-20" />
          </div>
